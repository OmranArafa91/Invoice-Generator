...
public class InvFrame extends javax.swing.JFrame {
    ...
    private InvsTabModel invoicesTableModel;

    public ArrayList<Inv> getInvs() {
        if (invs == null) invs = new ArrayList<>();
        return invs;
    }

    public void setInvs(ArrayList<Inv> invs) {
        this.invs = invs;
    }

    public InvsTabModel getInvoicesTableModel() {
        if (invoicesTableModel == null) {
            invoicesTableModel = new InvsTabModel(getInvs());
        }
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(InvsTabModel invoicesTableModel) {
